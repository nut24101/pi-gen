install -m 644 ./flutter-pi-img-gen/flutter-engine-binaries-for-arm/arm/libflutter_engine.so.* /flutter-pi-img-gen/engine-binaries/arm/icudtl.dat "${ROOTFS_DIR}/usr/lib/"
